            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="${basePath}/seller/product/index" class="sidebar-link">
                                <i class="icon-Record"></i>
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        ...
                        <li class="sidebar-item">
                            <a href="${basePath}/seller/category/index" class="sidebar-link">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link"
                       href="${basePath}/seller/logout" aria-expanded="false">
